...
int main(int argc,char* argv[]){
   ...
   6:	0800                	addi	s0,sp,16
    if(argc<1){
   8:	02a05063          	blez	a0,28 <main+0x28>
        printf("parameter error\n");
    }else{
        sleep(atoi(argv[1]));
   c:	6588                	ld	a0,8(a1)
   e:	00000097          	auipc	ra,0x0
  12:	1a2080e7          	jalr	418(ra) # 1b0 <atoi>
  16:	00000097          	auipc	ra,0x0
  1a:	32a080e7          	jalr	810(ra) # 340 <sleep>
    }
    exit(0);
  1e:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 398:	45c50513          	addi	a0,a0,1116 # 7f0 <digits>
 39c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 464:	390b8b93          	addi	s7,s7,912 # 7f0 <digits>
 ...
 5a4:	24890913          	addi	s2,s2,584 # 7e8 <malloc+0x102>
        while(*s != 0){
...
free(void *ap)
{
 ...
 66c:	1a07b783          	ld	a5,416(a5) # 808 <freep>
 ...
 69a:	00e6ea63          	bltu	a3,a4,6ae <free+0x50>
{
 ...
 6dc:	12f73823          	sd	a5,304(a4) # 808 <freep>
}
 6e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70e:	0fe53503          	ld	a0,254(a0) # 808 <freep>
 ...
 736:	0d690913          	addi	s2,s2,214 # 808 <freep>
  if(p == (char*)-1)
 73a:	5afd                	li	s5,-1
 73c:	a88d                	j	7ae <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 73e:	00000797          	auipc	a5,0x0
 742:	0d278793          	addi	a5,a5,210 # 810 <base>
 746:	00000717          	auipc	a4,0x0
 74a:	0cf73123          	sd	a5,194(a4) # 808 <freep>
 74e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 770:	08a73e23          	sd	a0,156(a4) # 808 <freep>
      return (void*)(p + 1);
